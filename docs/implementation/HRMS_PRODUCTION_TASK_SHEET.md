...
| Area | Status |
| --- | --- |
| Backend OpenAPI | 240 implemented operations across 211 paths |
...
2. Backend OpenAPI now has 240 operations across 211 paths; planned operations remaining are 0.
