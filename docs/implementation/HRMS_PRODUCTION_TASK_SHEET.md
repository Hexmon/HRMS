...
| Area | Status |
| --- | --- |
| Backend OpenAPI | 236 implemented operations across 207 paths |
...
2. Backend OpenAPI now has 236 operations across 207 paths; planned operations remaining are 0.
