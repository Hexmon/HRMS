...
| --- | ---: | --- | --- |
| Implemented APIs ready to integrate | 170 | Use generated client from `openapi.json`. | Keep behavior stable and fix bugs only. |
...
| Planned new APIs | 45 | Keep related frontend features mocked or behind integration flags. | Build by phase and mark complete only after tests/OpenAPI/docs pass. |
| Target implemented contract after completion | 215 | Regenerate frontend client only after each backend phase lands. | `170 current + 45 remaining`; Timesheet enhancements added 5 operations for project summaries, missing submissions, productivity, submission detail, and selectors. |
...
Total remaining planned new operations: **45**.
