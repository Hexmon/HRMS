...
| --- | ---: | --- | --- |
| Implemented APIs ready to integrate | 182 | Use generated client from `openapi.json`. | Keep behavior stable and fix bugs only. |
...
| Planned new APIs | 33 | Keep related frontend features mocked or behind integration flags. | Build by phase and mark complete only after tests/OpenAPI/docs pass. |
| Target implemented contract after completion | 215 | Regenerate frontend client only after each backend phase lands. | `182 current + 33 remaining`; Admin master data added department/designation management APIs. |
...
| --- | ---: | --- |
| Admin / Configuration | 14 | Company profile read/update, department/designation master-data management, finance governance, manager backups, and timesheet workflow definition upsert. |
...
Total remaining planned new operations: **33**.
