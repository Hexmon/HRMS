...
Current documented backend contract: **189 operations** in `openapi.json` after Phase 5 Admin workflow API completion.

- **187** operations are under `/api/v1/**`.
...
| -------------------------------------- | ----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Existing APIs ready to integrate as-is |   189 | Present in `openapi.json` and usable through the generated frontend client without path or workflow changes.                                                           |
...
| New APIs remaining to add              |    26 | Remaining first-pass count needed after Phase 5 Admin workflow API completion.                                                                                         |
| Target contract size after additions   |   215 | `189 current + 26 remaining`; Admin workflow configuration APIs are now available.                                                                                     |
...
| Admin settings                                    |               5 | Company profile, department/designation master data, RBAC role/permission configuration, and workflow configuration are implemented; policies, email templates, notification channels, security settings, and audit logs remain. |
...
| **Total remaining**                               |          **26** | Remaining operation count for full visible frontend coverage after Phase 5 Admin workflows.                                                                                                                                      |
...
| Admin settings             | `/admin-settings/*`                                                                                         | Company profile, department/designation master data, RBAC roles/permissions, workflow configs, finance governance, manager backups, timesheet workflow definitions.                                   | Policies, email templates, notification channels, security settings, audit logs.                                                                                                  |
