    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <ChartCard
          ...
          subtitle="Daily present headcount this week"
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <DataCard
          ...
          actions={
            <Button asChild size="sm" variant="ghost" className="text-primary">
              <Link to="/leave-wfh">
                Review all <ChevronRight className="ml-1 h-3.5 w-3.5" />
              </Link>
            </Button>
          }
        >
        ...
        <DataCard
          title="Announcements"
          description="Workspace-wide updates"
          padded={false}
          actions={
