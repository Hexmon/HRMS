...
export const TIMESHEET_WEEKS: TimesheetWeek[] = [
  {
    ...
    weekStart: LAST_WEEK,
    status: "approved",
    submittedAt: addDays(new Date(LAST_WEEK), 5).toISOString(),
    decidedAt: addDays(new Date(LAST_WEEK), 6).toISOString(),
    decidedBy: "Sara Iqbal",
  },
  {
    id: "tw_1042_tw",
    employeeId: "EMP-1042",
  ...
  },
  {
    id: "tw_1047_lw",
    employeeId: "EMP-1047",
    employeeName: "Hana Kobayashi",
    department: "Analytics",
    weekStart: LAST_WEEK,
    status: "returned",
    submittedAt: addDays(new Date(LAST_WEEK), 5).toISOString(),
    decidedBy: "Aanya Mehta",
    remarks: "Please add task descriptions for Tuesday.",
  },
  {
    id: "tw_1054_lw",
    employeeId: "EMP-1054",
    ...
    decidedAt: addDays(new Date(LAST_WEEK), 6).toISOString(),
    decidedBy: "Sara Iqbal",
    remarks: "Hours don't match deployment evidence.",
  },
  {
    id: "tw_1043_tw",
    employeeId: "EMP-1043",
