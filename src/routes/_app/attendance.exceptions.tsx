...
const LATE: Row[] = [
  {
    ...
    date: "Today",
    detail: "In at 09:47 (late 47 min)",
    status: "pending",
  },
  {
    id: "L-102",
    employee: "Mei Lin",
    date: "Today",
    detail: "In at 10:02 (late 62 min)",
    status: "pending",
  },
  {
    id: "L-103",
    ...
    date: "Yesterday",
    detail: "In at 09:36 (late 36 min)",
    status: "approved",
  },
];
const MISSING: Row[] = [
  {
    ...
    date: "Yesterday",
    detail: "Punched in 09:08, no punch-out",
    status: "pending",
  },
  {
    id: "M-202",
    ...
    date: "08 May",
    detail: "Punched in 09:18, no punch-out",
    status: "pending",
  },
];
const ABSENT: Row[] = [
...
const CORRECTIONS: Row[] = [
  {
    ...
    date: "07 May",
    detail: "Forgot to punch out — requested 18:30",
    status: "pending",
  },
  {
    id: "C-402",
    ...
    <div className="space-y-4 pt-2">
      ...
      <Tabs defaultValue="late">
        ...
        <TabsContent value="late" className="mt-4">
          <Queue rows={LATE} kind="Late" />
        </TabsContent>
        <TabsContent value="missing" className="mt-4">
          <Queue rows={MISSING} kind="Missing punch-out" />
        </TabsContent>
        <TabsContent value="absent" className="mt-4">
          <Queue rows={ABSENT} kind="Absence" />
        </TabsContent>
        <TabsContent value="correction" className="mt-4">
          <Queue rows={CORRECTIONS} kind="Correction" />
        </TabsContent>
      </Tabs>
    </div>
  );
